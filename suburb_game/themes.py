...
prospit = Theme("prospit")
prospit.white = Color(255, 255, 0)
prospit.light = Color(253, 137, 0)
prospit.dark = Color(227, 78, 14)

derse = Theme("derse")
derse.white = Color(199, 0, 255)
derse.light = Color(128, 13, 226)
derse.dark = Color(91, 29, 173)
# derse.white = Color(91, 29, 173)
# derse.light = Color(128, 13, 226)
# derse.dark = Color(199, 0, 255)