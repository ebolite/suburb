...
class Item():
    def __init__(self, item_name: str, item_dict: dict):
        ...
        self.onhit_states: dict[str, list] = self.item_dict["onhit_states"]
        self.wear_states: dict[str, list] = self.item_dict["wear_states"]
        self.consume_states: dict[str, list] = self.item_dict["consume_states"]
